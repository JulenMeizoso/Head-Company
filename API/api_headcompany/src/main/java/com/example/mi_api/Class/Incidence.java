...
public class Incidence extends ShowItem {
	...
	public Incidence(String autonomousRegion, String carRegistration, String cause, String cityTown, String direction,
			String endDate, String incidenceDescription, int incidenceId, String incidenceLevel, String incidenceName,
			String incidenceTypeString, double latitude, double longitude, double pkEnd, double pkStart,
		...
		this.incidenceType = IncidenceType.fromString(incidenceTypeString);
	...
	public String getIncidenceType() {
		return incidenceType.getTextoOriginal();
	}
	...
	public void setIncidenceType(String text) {
		this.incidenceType = IncidenceType.fromString(text);
	}
